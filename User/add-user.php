...
$title = "Tambah User - SDN 36 Cupak";
...
<select name="level" id="level" class="form-select border-0 border-bottom" required>
    <option value="" selected>--Level User--</option>
  ...
  <div class="mb-3 row">
    ...
    <div class="col-4 text-center px-5">
        ...
        <small calss="text-secondary">Pilih foto PNG, JPG atau JPEG dengan ukuran maximal 1MB</small>
        <div><small calss="text-secondary">Width = Height</small></div>
    </div>
   </div>
  </div>
</div>
