                                ...
                                <table class="table table-hover" id="datatablesSimple">
                                 <thead>
                                    <tr>
                                        ...
                                        <th scope="col"><center> Nilai Terendah
                                        </center></th>
                                        <th scope="col"><center>
                                            Nilai tertinggi
                                        </center></th>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" onclick="printDoc1()">OK</button>
      </div>
    </div>
  </div>
</div>
...
function printDoc1(){
        const myWindow = window.open("../report/r-nilai-ujian.php", "", "width=900, height=600, left=100");
    }
