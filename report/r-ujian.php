...
<div style="text-align: center">
    ...
    <h2 style="margin-bottom: 15px;">SDN 36 Cupak</h2>
</div>

<table>
    <thead>
        <tr>
            <td colspan="7" style=": 5px">
        ...
        <tr>
            ...
            <th style="width: 110px;">Hasil Ujian</th>
        </tr>
        <tr>
            <td colspan="7" >
    ...
    <tfoot>
        <tr>
            <td colspan="7">
                ...
                <p>Cupak, <?= date('j F Y') ?></p>
                <p>Dibuat oleh, <b>Dewan Guru SDN 36 Cupak</b></p>
            </td>
        </tr>
    </tfoot>
</table>
