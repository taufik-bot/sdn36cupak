...
while ($data = mysqli_fetch_array($queryPelajaran)) { ?>
    <tr>
        ...
        <td><input type="text" name="mapel[]" value="<?= $data['pelajaran'] ?>" class="boder-0 bg-transparent col-12" readonly></td>
        <td><input type="text" name="jurus[]" value="<?= $data['jurusan'] ?>" class="boder-0 bg-transparent col-12" readonly></td>
