...
$title = "Ganti Password - SDN 36 Cupak";
...
<form action="proses-password.php" method="POST">
  ...
  <input type="password" class="form-control" id="newPass" name="newPass" minlenght="4" maxlenght="20" placeholder="Masukkan Password baru anda"required>
</div>
  </div>
  <div class="mb-3 row">
  <div class="col-7">
