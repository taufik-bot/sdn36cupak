...
$title = "Profile Sekolah - SDN 36 Cupak";
...
if ($msg == 'notimage'){
  ...
  <i class="fa-solid fa-triangle-exclamation"></i> Update data sekolah, file yang anda upload bukan gambar..
  <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
</div>';
}
if ($msg == 'oversize'){
  $alert = '<div class="alert alert-warning alert-dismissible fade show" role="alert">
  <i class="fa-solid fa-triangle-exclamation"></i> Update data sekolah gagagl, maximal ukuran gambar 1 MB..
  <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
</div>';
}
if ($msg == 'updated'){
...
<div id="layoutSidenav_content">
  ...
  <div class="card-header">
    <span class="hs"><i class="fa-solid fa-pen-to-square"></i> Data Sekolah</span>
