...
$title = "Update Siswa - SDN 36 Cupak";
...
<div id="layoutSidenav_content">
  ...
  <div class="mb-3 row">
    ...
    <div class="col-sm-9" style="margin-left: -50px;">
      <input type="text" name="nama" class="form-control border-0 border-bottom ps-2" id="nama" required value="<?= $data['nama']?>">
    </div>
  </div>
  <div class="mb-3 row">
    ...
    <div class="col-sm-9" style="margin-left: -50px;">
     <textarea name="alamat" id="alamat" cols="30" rows="3" placeholder="alamat siswa" class="form-control" required><?=$data['alamat'] ?></textarea>
        ...
        <div class="col-4 text-center px-5">
          ...
          <small class="text-secondary">Pilih foto PNG, JPG atau JPEG dengan ukuran maximal ! MB</small>
